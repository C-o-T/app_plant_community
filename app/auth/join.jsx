...
const Join = () => {
  ...
  const checkDuplicate = async (type) => {
    const config = {
      memId: {
        ...
        url: `http://192.168.30.97:5000/members/checkId/${joinData.memId}`,
        emptyMsg: '아이디를 입력하세요.',
      ...
      memTell: {
        ...
        url: `http://192.168.30.97:5000/members/checkTell/${joinData.memTell}`,
        emptyMsg: '연락처를 입력하세요.',
      ...
      memBusinessNum: {
        ...
        url: `http://192.168.30.97:5000/members/checkBusinessNum/${joinData.memBusinessNum}`,
  ...
  const handleJoin = async () => {
    ...
    try {
      await axios.post('http://192.168.30.97:5000/members', joinData);
